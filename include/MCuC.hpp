...
//    bool mcOn        = false; ///< GPIO: Whether or not the motor controller is on.
    ...
    CO_OBJ_T objectDictionary[OBJECT_DICTIONARY_SIZE + 1] = {
        ...
        RECEIVE_PDO_MAPPING_START_KEY_16XX(0x00, 0x02), //node 0 quantity 2
        ...
        RECEIVE_PDO_MAPPING_START_KEY_16XX(0x01, 0x03), //node 1 quantity 3
        ...
        RECEIVE_PDO_MAPPING_START_KEY_16XX(0x02, 0x04), // node 2 quantity 4
        ...
        RECEIVE_PDO_MAPPING_START_KEY_16XX(0x03, 0x02), // node 4 quantity 2
