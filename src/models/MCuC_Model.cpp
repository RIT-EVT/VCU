...
namespace vcu
{
    ...
    // Function for Chart: '<Root>/MCuC_Chart'
    void MCuC_Model::MCuC_MC_Discharging(const bool *LogicalOperator, const bool
        *OR)
    {
        ...
        } else if ((MCuC_U.MC_DC_State_CAN == MC_DC_State::Complete) && ((*OR) ||
                    (!*LogicalOperator))) {
            // Transition: '<S11>:529'
            MCuC_DW.is_MC_Discharging = 0;
...
namespace vcu
{
    ...
    void MCuC_Model::step()
    {
        ...
        OR = ((MCuC_U.GFDB_Isolation_State_CAN != rtCP_pooled5) ||
        ...
        AND = ((MCuC_U.Brake_CAN > rtCP_pooled2) && MCuC_U.Forward_EN_CAN &&
               (MCuC_U.Throttle_CAN == rtCP_pooled2));
        ...
        if (MCuC_DW.isNotInit && (static_cast<uint16_t>
                                  (MCuC_DW.temporalCounter_i1) < 127)) {
        ...
        MCuC_Y.Watchdog = ((MCuC_DW.clockTickCounter <
                           ...
                           (MCuC_DW.clockTickCounter >= 0L) && rtCP_pooled4);
