...
namespace vcu
{
    ...
    void MCuC_Model::MCuC_MCuC(void)
    {
        ...
        guard1 = false;
        if (MCuC_U.HM_Fault && MCuC_U.Ignition_LS_A && tmp &&
                (!MCuC_DW.Fault_Activated)) {
            // Transition: '<S1>:356'
        ...
        } else if (MCuC_U.ESTOP_LS_A && MCuC_DW.uncharged && MCuC_U.nReset &&
                   (MCuC_Y.uC_State != UC_State::Preset)) {
            // Transition: '<S1>:200'
        ...
        } else if (MCuC_U.HM_Fault && MCuC_DW.uncharged && (MCuC_Y.uC_State !=
                    UC_State::Preset) && MCuC_U.nReset) {
            // Transition: '<S1>:201'
            MCuC_exit_internal_MCuC_Logic();
            ...
            switch (MCuC_DW.is_MCuC_Logic) {
              case MCuC_IN_Contactor_Closed:
                ...
                if (MCuC_U.Start && MCuC_U.Forward_EN && MCuC_U.Brake &&
                        (MCuC_U.Throttle == 0)) {
                    // Transition: '<S1>:17'
