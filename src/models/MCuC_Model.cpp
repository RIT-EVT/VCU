    ...
    void MCuC_Model::MCuC_exit_internal_Logic(void)
    {
        ...
        switch (MCuC_DW.is_Logic) {
          ...
          case MCuC_IN_Preset:
            ...
            // Outport: '<Root>/Self_Test'
            // Exit 'Preset': '<S10>:302'
            MCuC_Y.Self_Test = false;
            MCuC_DW.is_Logic = 0;
            break;
...
namespace vcu
{
    ...
    void MCuC_Model::step()
    {
        ...
        if (MCuC_DW.UnitDelay5_DSTATE == rtCP_Constant_Value) {
            ...
            tmp = static_cast<bool>(static_cast<int16_t>
                                    ((MCuC_DW.UnitDelay5_DSTATE != BMS_Contactor_Command::Open_Contactor) !=
                MCuC_U.BMS_Contactor_Closed_CAN ? 1 : 0) != 0);
        }
                ...
                if (OR && MCuC_DW.MC_Uncharged) {
                    ...
                    switch (MCuC_DW.is_Logic) {
                      ...
                      case MCuC_IN_Preset:
                        ...
                        if ((!MCuC_U.LVSS_ON_CAN) && (!MCuC_U.MC_ON) &&
                        ...
                        } else if (static_cast<uint16_t>(MCuC_DW.is_MC_ST) ==
                                   MCuC_IN_MC_EN_OFF) {
                            // Outport: '<Root>/MC_EN_uC'
                            MCuC_Y.MC_EN_uC = false;
        ...
        MCuC_Y.LED[0] = (MCuC_Y.LED[0] && rtCP_pooled3);
        MCuC_Y.LED[1] = (MCuC_Y.LED[1] && rtCP_pooled3);
        MCuC_Y.LED[2] = (MCuC_Y.LED[2] && rtCP_pooled3);

        // Chart: '<Root>/Cooling_Control_Chart'
        // Gateway: Cooling_Control_Chart
        // During: Cooling_Control_Chart
        if (static_cast<uint16_t>(MCuC_DW.is_active_c3_MCuC) == 0U) {
    ...
    {
        {
            ...
            // Outport: '<Root>/Self_Test' incorporates:
            //   Chart: '<Root>/MCuC_Chart'
            //
